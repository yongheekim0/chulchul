    ...
    <section className=" bg-gradient-to-r from-terracotta-200 h-[600px] pt-20">
      <div className="w-full h-[530px] bg-hero bg-no-repeat bg-cover bg-center flex py-[120px] pl-[150px]">
        <div className="basis-1/3 flex flex-col">
          ...
          <Link to='/'>
            <button className="text-[24px] font-semibold hover:bg-terracotta-400/50 hover:text-slate-200 py-2 px-4 rounded-2xl border bg-terracotta-400/30 shadow-md hover:scale-105 transition hover:-translate-y-[2px] active:-translate-y-[1px]">Right here</button>
          </Link>
        </div>
      </div>
    </section>
